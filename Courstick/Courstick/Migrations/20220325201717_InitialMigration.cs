        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Passing_Time = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    StatusId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Courses_SubTypes_SubTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionTypeSubTypeId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => x.SubscriptionId);
                    table.ForeignKey(
                        name: "FK_Subscriptions_SubTypes_SubscriptionTypeSubTypeId",
                        column: x => x.SubscriptionTypeSubTypeId,
                        principalTable: "SubTypes",
                        principalColumn: "SubTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUser", x => new { x.AuthorOfCourseId, x.AuthorUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUser1", x => new { x.CoursesCourseId, x.UsersUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubscriptionsSubscriptionId = table.Column<int>(type: "integer", nullable: false),
                    UsersUserId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionUser", x => new { x.SubscriptionsSubscriptionId, x.UsersUserId });
                    table.ForeignKey(
                        name: "FK_SubscriptionUser_Subscriptions_SubscriptionsSubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_SubscriptionTypeSubTypeId",
                table: "Subscriptions",
                column: "SubscriptionTypeSubTypeId");
